...
.. __: https://github.com/tsutterley/read-ICESat-2/blob/main/scripts/MPI_reduce_ICESat2_ATL11_ice_shelves.py

Calling Sequence
################

.. argparse::
    :filename: ../../scripts/MPI_reduce_ICESat2_ATL11_ice_shelves.py
    :func: arguments
    :prog: MPI_reduce_ICESat2_ATL11_ice_shelves.py
    :nodescription:
    :nodefault:
