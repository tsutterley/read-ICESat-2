...
chmod 0600 ~/.netrc
```
5. Sync data from NSIDC as [HDF5](https://github.com/tsutterley/read-ICESat-2/blob/master/scripts/nsidc_icesat2_sync.py) or [zarr](https://github.com/tsutterley/read-ICESat-2/blob/master/scripts/nsidc_icesat2_zarr.py), or use the [NSIDC subsetting API](https://github.com/tsutterley/nsidc-subsetter) to gather data  
