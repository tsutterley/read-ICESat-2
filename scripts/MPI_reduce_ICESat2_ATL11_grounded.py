...
def load_grounded_ice(base_dir, BUFFER, HEM, AREA=0.0):
    ...
    region_shapefile = base_dir.joinpath(*grounded_file[HEM])
    ...
    for ptx in sorted(IS2_atl11_pairs):
        ...
        for key in valid_keys:
            ...
            IS2_atl11_mask_attrs[ptx]['subsetting'][key]['description'] = ('Mask calculated '
                f'using delineations from the {grounded_description[HEM]}.')
            IS2_atl11_mask_attrs[ptx]['subsetting'][key]['reference'] = grounded_reference[HEM]
        ...
        IS2_atl11_mask_attrs[ptx]['subsetting']['land_ice'] = collections.OrderedDict()
        IS2_atl11_mask_attrs[ptx]['subsetting']['land_ice']['contentType'] = "referenceInformation"
        IS2_atl11_mask_attrs[ptx]['subsetting']['land_ice']['long_name'] = 'Grounded Ice Mask'
        IS2_atl11_mask_attrs[ptx]['subsetting']['land_ice']['description'] = ('Mask calculated '
            f'using delineations from the {grounded_description[HEM]}.')
        IS2_atl11_mask_attrs[ptx]['subsetting']['land_ice']['reference'] = grounded_reference[HEM]
        IS2_atl11_mask_attrs[ptx]['subsetting']['land_ice']['source'] = args.buffer
